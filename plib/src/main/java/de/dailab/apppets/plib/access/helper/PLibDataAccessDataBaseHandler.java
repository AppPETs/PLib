...
/**
 * Database handler for user decisions with respect to data access.
 * Created by arik on 16.02.2017.
 */

public class PLibDataAccessDataBaseHandler extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 5;

    // Database Name
    private static final String DATABASE_NAME = "DataAccessDB";
     ...
     * @param context
     */
    public PLibDataAccessDataBaseHandler(Context context) {

        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    /**
     * Adds or updates a new/old access decision, identified by an id if available
     *
     * @param decision
     */
    ...
    /**
     * Add a new access decision to the data base.
     *
     * @param decision
     */
    ...
    /**
     * Return an access decision if available, identified by the db id.
     *
     * @param id
     * @return
     */
    ...
    /**
     * Updating single access decision, identified by the db id.
     *
     * @param decision
     * @return
     */
    ...
    /**
     * Return an access decision if available, identified by a hash value.
     *
     * @param hash
     * @return
     */
    ...
    /**
     * Returns all access decisions, dependent on decision type.
     *
     * @return
     */
    ...
    /**
     * Returns the number of persistent access decisions.
     *
     * @return
     */
    ...
    /**
     * Removes access decision, identified by the db id.
     *
     * @param decision
     */
    ...
    /**
     * Removes access decision, identified by the  id.
     *
     * @param id
     */
